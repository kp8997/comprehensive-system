...
## Common mistakes
1. Jumping into answering the question immediately without first asking questions and gathering requirements.
2. Approaching the question in an unstructured manner, going all over the place and missing out on important areas.
Insisting on only one solution or the best solution without realizing that each solution has tradeoffs.
3. Remaining silent the entire time and only thinking in their head.
4. Going down a rabbit hole and spending too much time on unimportant areas.
4. Using buzzwords without being able to explain them.
